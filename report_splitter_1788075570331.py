...
class ReportSplitter(tk.Tk):
    ...
    def _build_history_table(self, parent):
        ...
        tk.Label(website_options, text="Website announcement:",
                 bg=CARD, fg=TEXT, font=FONT_BOLD).pack(side="left", padx=(0, 8))
        ...
        self.website_banner_button = self._b(
            website_options, "Choose Banner Image", self._browse_banner,
            bg="#0369a1", fg="white")
        ...
        announcement_row = tk.Frame(parent, bg=CARD)
        announcement_row.pack(fill="x", pady=(0, 10))
        tk.Radiobutton(
            announcement_row, text="Text announcement", variable=self.website_mode_var,
            value="text", command=self._update_website_media_mode,
            bg=CARD, fg=TEXT, activebackground=CARD,
            selectcolor=PRIMARY_PALE, font=FONT
        ).pack(side="left", padx=3)
    ...
    def _build_secret_settings(self, tab):
        ...
        self.secret_phone_entry = tk.Entry(
            phone_controls, textvariable=self.secret_phone_var,
            font=FONT, width=28)
        self.secret_phone_entry.pack(side="left", padx=(0, 6), ipady=4)
